...
### Opción 3: Modelo normal LRM_R

A continuación se muestran los resultados del modelo normal con LRM_R dentro del conjunto de entrenamiento, de modo que se muestra el tamaño de la muestra de entrenamiento ($n$), el *r-*cuadrado que muestra la varianza explciada por el modelo (R2), el error estándar de la estimación (EE), el valor p de la prueba de normalidad de Lilliefors (Normalidad), y el valor p de la prueba Breusch-Pagan para homocedasticidad (Homocedasticidad).
...
modelo_femenino <- lm(Talla ~ LRM_R + Edad, data = femenino)
r2_femenino <- summary(modelo_femenino)$r.squared
ee_femenino <- sqrt(mean(residuals(modelo_femenino)^2))
normalidad_femenino <- lillie.test(residuals(modelo_femenino))$p.value
homocedasticidad_femenino <- bptest(modelo_femenino)$p.value
...
modelo_masculino <- lm(Talla ~ LRM_R + Edad, data = masculino)
r2_masculino <- summary(modelo_masculino)$r.squared
ee_masculino <- sqrt(mean(residuals(modelo_masculino)^2))
normalidad_masculino <- lillie.test(residuals(modelo_masculino))$p.value
homocedasticidad_masculino <- bptest(modelo_masculino)$p.value
...
### Opción 4: Modelo normal LRM_90

A continuación se muestran los resultados del modelo normal con LRM_90 dentro del conjunto de entrenamiento, de modo que se muestra el tamaño de la muestra de entrenamiento ($n$), el *r-*cuadrado que muestra la varianza explciada por el modelo (R2), el error estándar de la estimación (EE), el valor p de la prueba de normalidad de Lilliefors (Normalidad), y el valor p de la prueba Breusch-Pagan para homocedasticidad (Homocedasticidad).
...
modelo_femenino <- lm(Talla ~ LRM_90 + Edad, data = femenino)
r2_femenino <- summary(modelo_femenino)$r.squared
ee_femenino <- sqrt(mean(residuals(modelo_femenino)^2))
normalidad_femenino <- lillie.test(residuals(modelo_femenino))$p.value
homocedasticidad_femenino <- bptest(modelo_femenino)$p.value
...
modelo_masculino <- lm(Talla ~ LRM_90 + Edad, data = masculino)
r2_masculino <- summary(modelo_masculino)$r.squared
ee_masculino <- sqrt(mean(residuals(modelo_masculino)^2))
normalidad_masculino <- lillie.test(residuals(modelo_masculino))$p.value
homocedasticidad_masculino <- bptest(modelo_masculino)$p.value
...
### Opción 5: Fórmulas de Benjumea LRT_A
...
### Opción 6: Fórmulas de Benjumea LRT_CM
...
### Opción 7: Fórmulas de Arango y Zamora LRM_R
...
### Opción 8: Fórmulas de Arango y Zamora LRM_90
...
Se muestra un resumen de los resultados del modelo normal con LRM_R sobre el conjunto de validación, por lo que se encuentra $n$ el  tamaño de muestra del conjunto de validación para cada subgrupo (femenino o masculino), el *r-*cuadrado (R2) y el error puro (Error_Puro).
...
# Para mujeres
# Ajustar el modelo en el conjunto de entrenamiento
modelo <- lm(Talla ~ LRM_R + Edad, data = femenino)
...
# Para hombres 
# Ajustar el modelo en el conjunto de entrenamiento
modelo <- lm(Talla ~ LRM_R + Edad, data = masculino)
...
Se muestra un resumen de los resultados del modelo normal con LRM_90 sobre el conjunto de validación, por lo que se encuentra $n$ el  tamaño de muestra del conjunto de validación para cada subgrupo (femenino o masculino), el *r-*cuadrado (R2) y el error puro (Error_Puro).
...
# Para hombres 
# Ajustar el modelo en el conjunto de entrenamiento
modelo <- lm(Talla ~ LRM_90 + Edad, data = masculino)
