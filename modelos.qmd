...
Para ajustar el modelo LASSO, se consideran todas las variables que podrían influir en la estimación de la talla: Edad, Sexo, Etnia y LRT_A. El modelo se encargará automáticamente de seleccionar las variables significativas. Antes de comenzar, los datos se dividen en dos conjuntos: entrenamiento (90%) y prueba (10%).
...
Se utiliza el método de***k-fold cross validation*** con $k = 10$ y y se calcula el promedio del MSE obtenido en cada iteración.
...
El MSE del modelo LASSO utilizando LRT_A es:
...
$$Talla = 56.74 + 2.19 LRT\_A - 0.12 Edad + 3.05 Sexo + 2.41 BM + 3.309 Ind + 3.93 Rrom$$\
$$Sexo = \begin{cases} 1 & \text{si sexo = Masculino} \\ 0 & \text{si sexo = Femenino} \end{cases}$$\
...
Para ajustar el modelo LASSO, se consideran todas las variables que podrían influir en la estimación de la talla: Edad, Sexo, Etnia y LRT_CM. El modelo se encargará automáticamente de seleccionar las variables significativas. Antes de comenzar, los datos se dividen en dos conjuntos: entrenamiento (90%) y prueba (10%).
...
El MSE del modelo LASSO utilizando LRT_CM es:
...
$$Talla = 55.19 + 2.16 LRT\_CM - 0.13 Edad + 4.12 Sexo + 2.07 BM + 2.76 Ind + 1.09 Rrom$$\
$$Sexo = \begin{cases} 1 & \text{si sexo = Masculino} \\ 0 & \text{si sexo = Femenino} \end{cases}$$\
$$BM = \begin{cases} 1 & \text{si Etnia = Blanco-Mestizo} \\ 0 & \text{en otro caso} \end{cases}$$\
$$Ind = \begin{cases} 1 & \text{si Etnia = Indigena} \\ 0 & \text{en otro caso} \end{cases}$$\
$$Rrom = \begin{cases} 1 & \text{si Etnia = Rrom} \\ 0 & \text{en otro caso} \end{cases}$$
...
Para ajustar el modelo LASSO, se consideran todas las variables que podrían influir en la estimación de la talla: Edad, Sexo, Etnia y LRM_R. El modelo se encargará automáticamente de seleccionar las variables significativas. Antes de comenzar, los datos se dividen en dos conjuntos: entrenamiento (90%) y prueba (10%).
...
El MSE del modelo LASSO utilizando LRM_R es:
...
$$Talla = 65.51 + 2.22 LRT\_CM - 0.11 Edad + 3.79 Sexo + 2.58 BM + 3.52 Ind + 5.33 Rrom$$\
$$Sexo = \begin{cases} 1 & \text{si sexo = Masculino} \\ 0 & \text{si sexo = Femenino} \end{cases}$$\
$$BM = \begin{cases} 1 & \text{si Etnia = Blanco-Mestizo} \\ 0 & \text{en otro caso} \end{cases}$$\
$$Ind = \begin{cases} 1 & \text{si Etnia = Indigena} \\ 0 & \text{en otro caso} \end{cases}$$\
$$Rrom = \begin{cases} 1 & \text{si Etnia = Rrom} \\ 0 & \text{en otro caso} \end{cases}$$
...
Para ajustar el modelo LASSO, se consideran todas las variables que podrían influir en la estimación de la talla: Edad, Sexo, Etnia y LRM_90. El modelo se encargará automáticamente de seleccionar las variables significativas. Antes de comenzar, los datos se dividen en dos conjuntos: entrenamiento (90%) y prueba (10%).
...
El MSE del modelo LASSO utilizando LRM_90 es:
...
lasso.coef
```
Los coeficientes distintos de cero, es decir, las variables seleccionadas por el modelo, son:
...
$$Talla = 65.58 + 2.20 LRT\_CM - 0.10 Edad + 4.65 Sexo + 0.13 BM + 0.14 Rrom$$\
$$Sexo = \begin{cases} 1 & \text{si sexo = Masculino} \\ 0 & \text{si sexo = Femenino} \end{cases}$$\
$$BM = \begin{cases} 1 & \text{si Etnia = Blanco-Mestizo} \\ 0 & \text{en otro caso} \end{cases}$$\
$$Ind = \begin{cases} 1 & \text{si Etnia = Indigena} \\ 0 & \text{en otro caso} \end{cases}$$\
$$Rrom = \begin{cases} 1 & \text{si Etnia = Rrom} \\ 0 & \text{en otro caso} \end{cases}$$
...
No parecen dar buenas estimaciones.
